        ...
        extends javax.swing.JDialog
{
  ...
  @SuppressWarnings("unchecked")
    ...
    {//GEN-HEADEREND:event_BtnLogInActionPerformed
      ...
      if (user != null)
      {
        ContinuarConPantallaPrinciapal(user);
      } else
      {
    ...
    {//GEN-HEADEREND:event_ConfirmarActionPerformed
      ...
      } else
      {
        ...
        Usuario user = ges.registrarUsuario(TfiNombre.getText(), TfiApellidos.getText(), nacimiento,
                                            TfiUsuarioRegistro.getText(), contraseña);
        if (user == null)
        {
  ...
  private void ContinuarConPantallaPrinciapal(Usuario user)
  {
    FrmPrincipal principal = (FrmPrincipal) this.getParent();
    principal.user = user;
    this.dispose();
  }
